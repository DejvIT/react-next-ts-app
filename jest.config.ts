...
const jestConfigOverride = {
  ...
  // cacheDirectory: "/private/var/folders/gm/lg1crmw15mxd8kgdbsl0msn40000gn/T/jest_dx",
  ...
  setupFiles: ['./__tests__/setupJestMock.ts'],
  ...
  testMatch: ['**/__tests__/^(?!mock-data)**/*.[jt]s?(x)', '**/?(*.)+(spec|test).[tj]s?(x)'],
...
module.exports = createJestConfig(jestConfigOverride);
